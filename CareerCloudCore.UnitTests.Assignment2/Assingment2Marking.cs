...
namespace CareerCloud.UnitTests.Assignment2
{
    ...
    //    protected readonly IUserConfiguration _userConfiguration;

    //    public Assingment2Marking()
    //    {
    //        IApplicationRequirements<Assingment2Marking> requirements  = ConsoleHostBuilderHelper.CreateApplicationRequirements<Assingment2Marking>(new string[]{});

    //        _userConfiguration = requirements.UserConfiguration; 
    //        _connStr = _userConfiguration.ConnectionString("CareerCloud");
    //    }
    ...
    //    {
    //        ApplicantEducationRepository poco = new ApplicantEducationRepository(_userConfiguration);
    ...
    //        _dbConstraints = new DatabaseConstraints(_connStr);
    //    }
    ...
    //    {
    //        ApplicantEducationRepository repo = new ApplicantEducationRepository(_userConfiguration);
    ...
    //                {
    //                    object[] callParams = new object[]{ _userConfiguration };
    //                    ;
    //                    object classInstance = Activator.CreateInstance(type, callParams);
    ...
    //        CompanyProfileRepository companyProfileRepo = new CompanyProfileRepository(_userConfiguration);
    ...
    //        CompanyDescriptionRepository repo = new CompanyDescriptionRepository(_userConfiguration);
    ...
    //        SecurityRoleRepository repo = new SecurityRoleRepository(_userConfiguration);
    ...
    //        CompanyJobRepository repo = new CompanyJobRepository(_userConfiguration);
    ...
    //        CompanyJobDescriptionRepository repo = new CompanyJobDescriptionRepository(_userConfiguration);
    ...
    //        CompanyLocationRepository repo = new CompanyLocationRepository(_userConfiguration);
    ...
    //        CompanyJobEducationRepository repo = new CompanyJobEducationRepository(_userConfiguration);
    ...
    //        CompanyJobSkillRepository repo = new CompanyJobSkillRepository(_userConfiguration);
    ...
    //        SecurityLoginRepository repo = new SecurityLoginRepository(_userConfiguration);
    ...
    //        SecurityLoginsLogRepository repo = new SecurityLoginsLogRepository(_userConfiguration);
    ...
    //        ApplicantProfileRepository repo = new ApplicantProfileRepository(_userConfiguration);
    ...
    //        ApplicantJobApplicationRepository repo = new ApplicantJobApplicationRepository(_userConfiguration);
    ...
    //        ApplicantResumeRepository repo = new ApplicantResumeRepository(_userConfiguration);
    ...
    //        ApplicantSkillRepository applicantSkillRepository = new ApplicantSkillRepository(_userConfiguration);
    ...
    //        ApplicantWorkHistoryRepository repo = new ApplicantWorkHistoryRepository(_userConfiguration);
    ...
    //        SystemCountryCodeRepository systemCountryCodeRepository = new SystemCountryCodeRepository(_userConfiguration);
    ...
    //        SystemLanguageCodeRepository systemLanguageCodeRepository = new SystemLanguageCodeRepository(_userConfiguration);
    ...
    //    {
    //        SystemLanguageCodeRepository systemLanguageCodeRepo = new SystemLanguageCodeRepository(_userConfiguration);
    ...
    //    {
    //        CompanyDescriptionRepository companyDescriptionRepo = new CompanyDescriptionRepository(_userConfiguration);
    ...
    //    {
    //        CompanyJobRepository companyJobRepo = new CompanyJobRepository(_userConfiguration);
    ...
    //    {
    //        CompanyJobDescriptionRepository companyJobDescRepo = new CompanyJobDescriptionRepository(_userConfiguration);
    ...
    //    {
    //        CompanyLocationRepository companyLocationRepo = new CompanyLocationRepository(_userConfiguration);
    ...
    //    {
    //        CompanyJobEducationRepository companyJobEducationRepo = new CompanyJobEducationRepository(_userConfiguration);
    ...
    //    {
    //        CompanyJobSkillRepository companyJobSkillRepository = new CompanyJobSkillRepository(_userConfiguration);
    ...
    //    {
    //        SecurityLoginRepository securityLoginRepository = new SecurityLoginRepository(_userConfiguration);
    ...
    //    {
    //        SecurityLoginsLogRepository securityLoginLogRepository = new SecurityLoginsLogRepository(_userConfiguration);
    ...
    //    {
    //        SecurityRoleRepository securityRoleRepository = new SecurityRoleRepository(_userConfiguration);
    ...
    //    {
    //        SecurityLoginsRoleRepository securityLoginRoleRepository = new SecurityLoginsRoleRepository(_userConfiguration);
    ...
    //    {
    //        ApplicantProfileRepository applicantProfileRepository = new ApplicantProfileRepository(_userConfiguration);
    ...
    //    {
    //        ApplicantEducationRepository applicantEducationRepository = new ApplicantEducationRepository(_userConfiguration);
    ...
    //    {
    //        ApplicantJobApplicationRepository applicantJobApplicationRepository = new ApplicantJobApplicationRepository(_userConfiguration);
    ...
    //    {
    //        ApplicantResumeRepository applicantResumeRepository = new ApplicantResumeRepository(_userConfiguration);
    ...
    //    {
    //        ApplicantWorkHistoryRepository applicantWorkHistoryRepository = new ApplicantWorkHistoryRepository(_userConfiguration);
    ...
    //    {
    //        ApplicantSkillRepository applicantSkillRepository = applicantSkillRepository = new ApplicantSkillRepository(_userConfiguration);
